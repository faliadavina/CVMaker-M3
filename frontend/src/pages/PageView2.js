...
const PageView2 = () => {
  ...
  const getUsers = async () => {
    try {
      const response = await axios.get(
        `https://api-cvmaster.agilearn.id/users/${decryptedIdAkun}`
      );
  ...
  const getSkills = async () => {
    try {
      const response = await axios.get(
        `https://api-cvmaster.agilearn.id/skills/akun/${decryptedIdAkun}`
      );
  ...
  useEffect(() => {
    const fetchOrganisasi = async () => {
      try {
        const response = await axios.get(
          `https://api-cvmaster.agilearn.id/organisasi/akun/${decryptedIdAkun}`
        );
  ...
  const getPorto = async () => {
    try {
      const response = await axios.get(
        `https://api-cvmaster.agilearn.id/porto/${decryptedIdAkun}`
      );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://api-cvmaster.agilearn.id/pendidikan/akun/${decryptedIdAkun}`
        );
