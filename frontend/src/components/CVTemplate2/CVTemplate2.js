                ...
                <header>
                    <div className="header-container-cv2">
                        <div className='side-container-cv2'>
                            ...
                            {data_diri?.nama && (
                                <h2 style={{ fontFamily: 'Poppins', color: 'white' }}><strong>{data_diri.nama}</strong></h2>
                            )}
                            ...
                            <div className='skill-container-cv2'>
                                <h2 style={{ fontFamily: 'Poppins', color: 'white', marginTop: '40px' }}><strong>S K I L L</strong></h2>
                                <hr style={{ borderTop: '3px solid #FFFFFF', margin: '5px 0', opacity: 1.0 }} />
                                {hardSkills && (
                                    <table>
                                        <tbody>
                                            {hardSkills.map((skill) => (
                                                <tr key={skill.id_skill} style={{ height: '35px', color: 'white', fontWeight: '600', fontSize: '14px' }}>
                            ...
                            <div className='contact-container-cv2'>
                                <h2 style={{ fontFamily: 'Poppins', color: 'white', marginTop: '60px' }}><strong>C O N T A C T</strong></h2>
                                <hr style={{ borderTop: '3px solid #FFFFFF', margin: '5px 0', opacity: 1.0 }} />
                                <table>
                                    <tbody>
                                        {data_diri?.telp && (
                        ...
                        <div className='side-container-cv2-2'>
                            <div className='personal-data-container-cv2' style={{ fontFamily: 'Poppins', fontSize: '14px', color: 'white', textAlign: 'left', lineHeight: '15px' }}>
                                <h2 style={{ marginTop: '20px', color: 'white' }}><strong>PERSONAL DATA</strong></h2>
                                ...
                                <h2 style={{ marginTop: '30px', color: 'white' }}><strong>EDUCATION</strong></h2>
                                <hr style={{ borderTop: '3px solid #FF7F09', margin: '5px 0', opacity: 1.0 }} />
                                ...
                                <div className='org-container-cv2'>
                                    <h2 style={{ marginTop: '30px', color: 'white' }}><strong>ORGANIZATION</strong></h2>
                                    <hr style={{ borderTop: '3px solid #FF7F09', margin: '5px 0', opacity: 1.0 }} />
                                ...
                                <div className='porto-container-cv2'>
                                    <h2 style={{ marginTop: '30px', color: 'white' }}><strong>PORTOFOLIO</strong></h2>
                                    <hr style={{ borderTop: '3px solid #FF7F09', margin: '5px 0', opacity: 1.0 }} />
                                    <ul>
                                        {portofolios &&
